#!/usr/bin/python3
"""This module serves as a unittest suite for the City class.
...
class TestCityInit(unittest.TestCase):
    """Test cases for the initialization of the City class.
    """
    def setUp(self):
    ...
    def test_parent_class_is_BaseModel(self):
        """Test if the parent of the City class is BaseModel
        """
    ...
    def test_public_attributes(self):
        ...
        self.assertEqual(str, type(obj.state_id))

    def test_empty_city_attributes(self):
        """Test empty city attribute values.
        """
        obj = City()
...
class TestCityStr(unittest.TestCase):
    """Test cases for the __str__ method of the City class.
    """
    def setUp(self):
        """Rename the storage file, so it doesn't get overwrited
    ...
    def test_formated_output(self):
        """ Test the formatted string output of the City object.
        """
        obj = City()
        obj.id = '1809'
